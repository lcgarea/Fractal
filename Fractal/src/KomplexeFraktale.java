...
public class KomplexeFraktale {
    ...
    public static void main(String[] args) {
        KomplexeFraktale gui = new KomplexeFraktale();
        gui.go();
    }
    ...
    public void go(){
       ...
       fractalChooser = new JComboBox<>(
        ...
        .filter(f -> !(f.getFractalPanel() instanceof FractalBase))
    ...
    public class colorListener implements ChangeListener{
        ...
        public void stateChanged(ChangeEvent e){
            ...
            System.out.println("Slider Red: " + red);
        System.out.println("Slider Green: " + green);
        System.out.println("Slider Blue: " + blue);
